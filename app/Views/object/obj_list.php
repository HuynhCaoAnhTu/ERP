          ...
          <div class="row">
			...
			<input type="hidden" id="ostyle" name="ostyle" class="form-control">
						...
						<div class="row">
							<div class="col-md-2">
								<div class="form-group mb-3">
									...
									<input type="text" id="ocode" name="ocode" class="form-control" placeholder="Ocode" minlength="3"  maxlength="10" required value = '<?= $ostyle ?>'>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group mb-3">
							...
							<div class="col-md-4">
								<div class="form-group mb-3">
									...
									<select id="location" name="location" class="form-select" >
										<option value="select1">Đà Nẵng, Việt Nam</option>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group mb-3">
									<label for="ofilter" class="col-form-label">Keyword: </label>
