						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group mb-3">
									...
									<select id="location_id" name="location_id" class="form-control  select2" data-placeholder="Select multi value" style="width: 100%;height:38px;" >
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          //insert data to form
			...
			//$(".select2").val(JSON.parse(response.ofilter)).trigger('change');
