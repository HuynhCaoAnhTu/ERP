		...
		<div class="card card-info card-tabs">
			<div class="card-header p-0 pt-1">
				<ul class="nav nav-tabs" id="scmTab" role="tablist">
				  ...
				  <li class="nav-item" role="presentation">
					<button class="nav-link" id="rates-tab" data-bs-toggle="tab" data-bs-target="#rates" type="button" role="tab" aria-controls="rates" aria-selected="false">Customer care</button>
				  </li>
				  <li class="nav-item" role="presentation">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group mb-3">
									...
									<select id="location_id" name="location_id" class="form-control select2" data-placeholder="Select value" style="width: 100%;height:38px;" >
						...
						<div class="row">
							...
							<div class="col-md-6" id='select2pr'>
								<div class="form-group mb-3">
									...
									<select id="ofilter" name="ofilter[]" class="form-control select2" multiple="multiple" data-placeholder="Select multi value" style="width: 100%;">
    ...
    var table = $('#data_table').removeAttr('width').DataTable({
      ...
      "ajax": {
		...
		dataSrc: function (response) { // X-CSRF-TOKEN Update
				...
				$.each(response.ofilter,function(index,data){
					$('#ofilter').append('<option value="'+data['id']+'">'+data['name']+'</option>');
                });
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          //insert data to form
			...
			//$('#data-form #location_id').val(data.id).trigger('change');
			...
			$("#data-form #ofilter").val(JSON.parse(response.ofilter)).trigger('change');
